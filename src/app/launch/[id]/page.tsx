  ...
  return (
    <div className="launch-page">
      <div className="launch-header">
        ...
        <div
          className={`launch-header__status launch-header__status--${
        ...
        <div className="launch-sidebar">
          <div className="launch-patch">
            {launch.links.patch.large ? (
              ...
              <div className="launch-patch__placeholder">
                No Patch Image
              </div>
            )}
          </div>
        ...
        <div className="launch-main">
          <section className="launch-section">
            ...
            <p className="launch-section__text">
              {launch.details ||
                "No description available for this mission."}
            </p>
          </section>
                ...
                {launch.cores.map((core: Core, index: number) => (
                  <div key={index} className="core-item">
                    ...
                    <div className="core-stat">
                      ...
                      {core.reused && (
                        <span className="core-stat__badge">
                          Reused
                        </span>
                      )}
                    </div>
                    ...
                    <div className="core-stat">
                      ...
                      {core.landing_attempt ? (
                        core.landing_success ? (
                          ...
                          <span className="core-stat__value core-stat__value--failure">
                            Failed
                          </span>
                        )
                      ) : (
          ...
          {launch.failures.length > 0 && (
            <section className="launch-section failure-section">
              <h3 className="failure-section__title">
                Failure Report
              </h3>

              <p className="failure-section__text">
