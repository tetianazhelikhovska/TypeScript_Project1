...
export default async function Home({ searchParams }: Props) {
  ...
  return (
    <div className="launches-page">
      ...
      <h1 className="launches-page__title">SpaceX Launches</h1>
      ...
      <div className="launches-list">
        {currentLaunches.length > 0 ? (
          ...
          <div className="launches-empty">No launches found matching your filters</div>
        )}
      </div>
      <div className="pagination">
        {currentPage > 1 ? (
          <Link href={getPageUrl(currentPage - 1)} className="pagination__btn">← Prev</Link>
        ...
        {currentPage < totalPages ? (
          <Link href={getPageUrl(currentPage + 1)} className="pagination__btn">Next →</Link>
